use crate::{constants::Accuracy, controller::Controller};
...
impl Default for PidController {
    fn default() -> Self {
        Self {
            kp: Vector::new(20., 10., 0.1),
            ki: Vector::new(1.1, 1.1, 1.1),
            kd: Vector::ONE * 10.0,
...
impl Controller for PidController {
    fn update(
        ...
        setpoint: Vector,
        measurement: Vector,
        dt: crate::constants::Accuracy,
    ) -> Vector {
        PidController::update(self, setpoint, measurement, dt)
    }
    fn reset(&mut self) {
